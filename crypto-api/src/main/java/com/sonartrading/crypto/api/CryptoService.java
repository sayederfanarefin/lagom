...
/**
 * The crypto service interface.
 * <p>
 * This describes everything that Lagom needs to know about how to serve and
 * consume the CryptoService.
 */
        ...
        return named("crypto")
                ...
                .withTopics(
                        topic("hello-events", this::helloEvents)
                                ...
                                .withProperty(KafkaProperties.partitionKeyStrategy(), CryptoEvent::getName)
                )
                .withAutoAcl(true);
    }
}
