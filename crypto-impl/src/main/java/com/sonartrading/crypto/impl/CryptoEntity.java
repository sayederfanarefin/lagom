...
/**
 * This is an event sourced entity. It has a state, {@link CryptoState}, which
 ...
 */
public class CryptoEntity extends PersistentEntity<CryptoCommand, CryptoEvent, CryptoState> {
    /**
     * An entity can define different behaviours for different states, but it will
     * always start with an initial behaviour. This entity only has one behaviour.
     */
    @Override
    public Behavior initialBehavior(Optional<CryptoState> snapshotState) {
        /*
        ...
        BehaviorBuilder b = newBehaviorBuilder(
                snapshotState.orElse(new CryptoState("Hello", LocalDateTime.now().toString()))
        );
        ...
        b.setEventHandler(GreetingMessageChanged.class,
                ...
                // the event.
                evt -> new CryptoState(evt.message, LocalDateTime.now().toString())
        );
