...
/**
 * This interface defines all the events that the CryptoEntity supports.
 * <p>
 * By convention, the events should be inner classes of the interface, which
 * makes it simple to get a complete picture of what events an entity has.
 */
public interface CryptoEvent extends Jsonable, AggregateEvent<CryptoEvent> {
    /**
     ...
     * events.
     */
    AggregateEventShards<CryptoEvent> TAG = AggregateEventTag.sharded(CryptoEvent.class, 4);
    ...
    @Override
    default AggregateEventTagger<CryptoEvent> aggregateTag() {
        return TAG;
    }
}
